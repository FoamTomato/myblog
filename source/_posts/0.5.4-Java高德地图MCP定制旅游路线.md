...
categories:
  - AI与大模型
description: "使用Java集成高德地图MCP服务，打造智能化的定制旅游路线规划系统。本文将带你从零开始，掌握高德地图Java SDK的使用技巧，实现完整的旅游路线规划功能。"
permalink: ai-llm/java-amap-mcp-travel-routes/
redirect_from:
  - "2025/01/17/0.5.4-Java高德地图MCP定制旅游路线/"
---
