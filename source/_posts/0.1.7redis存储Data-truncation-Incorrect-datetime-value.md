...
categories:
  - 数据库
description: "最近在编写项目时，用redis存储结果一直报转换异常"
permalink: database/redis-data-truncation-incorrect-datetime/
redirect_from:
  - "2022/03/07/0.1.7redis存储Data-truncation-Incorrect-datetime-value/"
---
