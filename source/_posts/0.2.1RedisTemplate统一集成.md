...
categories:
  - 数据库
description: "使用@Autowired的时候，对于static标识的变量或者方法一般是获取到的null值常规的方法已经使用不了"
permalink: database/redistemplate-unified-integration/
redirect_from:
  - "2022/05/06/0.2.1RedisTemplate统一集成/"
---
