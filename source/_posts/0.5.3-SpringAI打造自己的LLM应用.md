...
categories:
  - AI与大模型
description: "Spring AI是Spring官方推出的AI框架，为Java开发者提供了原生的AI开发体验。本文将带你从零开始，掌握Spring AI的核心概念和Spring Boot集成技巧，打造属于自己的AI应用。"
permalink: ai-llm/spring-ai-llm-app/
redirect_from:
  - "2025/01/16/0.5.3-SpringAI打造自己的LLM应用/"
---
