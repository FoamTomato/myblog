...
categories:
  - 技术随笔
description: "目前项目引入了 xxljob 来跑定时任务，但是存在一个问题，项目执行结束的时间不固定，有峰值，在高峰期的时候会出现长阻塞一直排队等待，如图："
permalink: notes/xxl-job-next-trigger-time/
redirect_from:
  - "2023/06/06/0.4.1-控制xxl-job下次执行时间/"
---
