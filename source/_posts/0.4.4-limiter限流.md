...
categories:
  - 工程实践
description: "采用 Google 的 Guava 中的 RateLimiter.create 来进行令牌桶的分发，但是我们需要动态控制限流的速率，所以在这上面利用单例模式的“ 双重检查锁 ”和 “懒汉式”来进行动态创建"
permalink: engineering/rate-limiter/
redirect_from:
  - "2023/06/06/0.4.4-limiter限流/"
---
